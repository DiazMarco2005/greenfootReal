...
public class MyWorld extends World
{
    ...
    private void prepare() {
        ...
        PlatformA platformA16 = new PlatformA();
        addObject(platformA16,236,281);
        platformA16.setLocation(224,317);
        platformA16.setLocation(217,317);
        PlatformA platformA17 = new PlatformA();
        addObject(platformA17,608,305);
        platformA17.setLocation(641,294);
        platformA16.setLocation(227,309);
        platformA17.setLocation(640,281);
        platformA16.setLocation(246,305);
        removeObject(platformA16);
        platformA17.setLocation(638,279);
        removeObject(platformA17);
        PlatformB platformB14 = new PlatformB();
        addObject(platformB14,181,282);
        platformB14.setLocation(221,302);
        PlatformB platformB15 = new PlatformB();
        addObject(platformB15,637,283);
        platformB15.setLocation(652,284);
    }
    ...
    public void act() {
        ...
        timer++;
        SpecialItem SpecialItem = new SpecialItem();
        if (timer % 1800 == 0) {  // 30 segundos, dado que el act() se llama 60 veces por segundo
            if (SpecialItem != null) {
                removeObject(SpecialItem);  // Eliminar el item especial actual
            }
            specialitem = new SpecialItem();
            addObject(specialitem, Greenfoot.getRandomNumber(600), Greenfoot.getRandomNumber(400));  // Crear un nuevo item especial en una posición aleatoria
        }}
